...
export const CreateCustomer = () => {
  ...
  const submit = async (e) => {
    ...
    try {
      // console.log(data);
      const { data: resData } = await axiosInstance.post(`clients/`, data);
      // console.log(resData);
      if (resData?.success) {
        toast.success("Customer Addded");
        navigate("/customers");
      }
      // navigate(`/customers/branch/create/${resp.data}`);
    } catch (error) {
      toast.error(error);
    }
  };
        ...
        <div className="col-sm-12 col-xs-12 col-md-12 container pull-left table-bordered-new mb-3 p-3 shadow">
          <div className="the-box">
            <form onSubmit={(e) => submit(e)} className="d-flex flex-wrap">
              ...
              {/* <div className="form-group col-md-6 px-2 mb-3">
                <label className="mb-1">
                  Company Group Name:<span className="req">*</span>
                </label>
                <input
                  type="text"
                  name="group_name"
              ...
              <div className="form-group col-md-6 px-2 mb-3">
                <label className="mb-1">
                  Phone Number 1:<span className="req">*</span>
                </label>
              ...
              <div className="form-group col-md-6 px-2 mb-3">
                <label className="mb-1">Fax Number :</label>

                <input
                  type="text"
                  name="quotation"
                  value={data.fax_number_1}
                  onChange={(e) => handle(e)}
                  className="form-control"
                  id="fax_number_1"
                />
              ...
              <div className="form-group col-md-6 px-2 mb-3">
                ...
                <select
                  required
                  name="industry_type_id_1"
                  className="form-select"
                  id="industry_type_id_1"
                  value={data.industry_type_id_1}
                  onChange={(e) => handle(e)}
                >
              ...
              <div className="form-group col-md-6 px-2 mb-3">
                ...
                <select
                  required
                  name="industry_type_id_2"
                  className="form-select"
                  id="industry_type_id_2"
                  value={data.industry_type_id_2 || ""}
                  onChange={(e) => handle(e)}
                >
                  <option value="">Select</option>
              ...
              {/* <div className="form-group col-md-6 px-2 mb-3">
                ...
                <select
                  name="industry_type_id_3"
                  className="form-select"
                  id="industry_type_id_3"
                  value={data.industry_type_id_3}
                  onChange={(e) => handle(e)}
                >
              ...
              <div className="form-group col-md-6 px-2 mb-3">
                ...
                <select
                  required
                  className="form-select"
                  name="turnover_ranges"
                  id="turnover_range_id"
                  value={data.turnover_range_id}
                  onChange={(e) => handle(e)}
                >
                  <option value="">Select</option>
                  {turnover &&
              ...
              <div className="form-group col-md-6 px-2 mb-3">
                ...
                <select
                  ...
                  id="employee_range_id"
                  value={data.employee_range_id}
                  onChange={(e) => handle(e)}
                >
                  <option value="">Select</option>
                  {employeeRanges &&
              ...
              <div className="form-group col-md-6 px-2 mb-3">
                ...
                >
                  ...
                  <option value="govtpsu">Government/PSU</option>
