...
export const UpdateContact = () => {
    ...
    const getBranches = async () => {
        const { data } = await axiosInstance.get(`clients/branch/viewall/${cid}`)
        setBranches(data);
    ...
    const submit = async (e) => {
        ...
        try {
            console.log(data);
            const { result } = await axiosInstance.put(`clients/contact/update/${id}`, ddata
            )
        ...
        <>
            ...
            <div className="row container ">
                ...
                <form onSubmit={(e) => submit(e)} className="d-flex flex-wrap">
                        ...
                        <div className="form-group col-md-6 px-2 mb-3">
                            <label className="mb-1">Department:<span className="req">*</span></label>

                            <input type="text" name="quotation" value={ddata.department} onChange={(e) => handle(e)} className="form-control" id="department" />
                        ...
                        <div className="form-group col-md-6 px-2 mb-3">
                            <label className="mb-1">Residential Address:<span className="req">*</span></label>

                            <input type="text" name="quotation" value={ddata.residential_address} onChange={(e) => handle(e)} className="form-control" id="residential_address" />
