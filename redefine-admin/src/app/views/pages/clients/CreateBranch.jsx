...
export const CreateBranch = () => {
    ...
    const submit = async (e) => {
        ...
        try {
            console.log(data);
            const { result } = await axiosInstance.post(`clients/branch/`, ddata
            )
            swal("Yeah", "Branch Created", "success");
                ...
                <div className="col-sm-12 col-xs-12 col-md-12 mx-auto table-bordered-new mb-3 p-3 shadow">
                    <form onSubmit={(e) => submit(e)} className="d-flex flex-wrap">
                        ...
                        <div className="form-group col-md-6 px-2 mb-3">
                            ...
                            <input type="text" name="quotation" value={ddata.phone_number_1} onChange={(e) => handle(e)} className="form-control" id="phone_number_1" />
