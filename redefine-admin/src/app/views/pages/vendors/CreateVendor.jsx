...
export const CreateVendor = () => {
  ...
  const submit = async (e) => {
    e.preventDefault();
    try {
      const res = await axiosInstance.post(`vendors/`, data);
      if (res.data?.error) {
        return toast.error(res.data?.error?.sqlMessage);
      }
      if (res.status === 200) {
        if (res.data?.success) {
          ...
          <div className="the-box">
            <form onSubmit={(e) => submit(e)} className="d-flex flex-wrap">
              ...
              {/* <div className="form-group col-md-6 px-2 mb-3">
                                ...
                                <select name="service" className="form-select" id="service" value={data.service} onChange={(e) => handle(e)}>
