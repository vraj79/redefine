...
export const UpdateTurnoverRanges = () => {
    ...
    const getOneData = async () => {
        const { data } = await axiosInstance.get(`masterturnoverranges/view/${dataId}`)
        console.log(data[0]);
        console.log(data);
    ...
    const submit = async (e) => {
        ...
        if (!ddata.name) {
            ...
            validation(true, element, "Enter Turnover Range", pElement);
            err = true;
        ...
        try {
            console.log(data);
            if (!err) {
            const { result } = await axiosInstance.put(`masterturnoverranges/update/${dataId}`, ddata
            )
            swal("Yeah", "Turnover Range Updated", "success");
        ...
        <>
            ...
            <div className="row align-items-center mb-3">
                    <div className="col-md-6">
                        <h3 className="my-2">Create Turnover Range</h3>
                    </div>
                    <div className="col-md-6 text-end">
                        <Link to="/master/turnover-ranges" className="btn btn-warning" >View All Turnover Ranges</Link>
                    </div>
                </div>
