...
export const UpdateEmployeeRanges = () => {
    ...
    const getOneData = async () => {
        const { data } = await axiosInstance.get(`masteremployeeranges/view/${dataId}`)
        console.log(data[0]);
        console.log(data);
    ...
    const submit = async (e) => {
        ...
        if (!ddata.name) {
            ...
            validation(true, element, "Enter Employee Range", pElement);
            err = true;
        ...
        try {
            console.log(data);
            if (!err) {
            const { result } = await axiosInstance.put(`masteremployeeranges/update/${dataId}`, ddata
            )
            swal("Yeah", "Employee Range Updated", "success");
        ...
        <>
            ...
            <div className="row align-items-center mb-3">
                    <div className="col-md-6">
                        <h3 className="my-2">Create Employee Range</h3>
                    </div>
                    <div className="col-md-6 text-end">
                        <Link to="/master/employee-ranges" className="btn btn-warning" >View All Employee Ranges</Link>
                    </div>
                </div>
