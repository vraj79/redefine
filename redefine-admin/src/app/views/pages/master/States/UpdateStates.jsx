...
export const UpdateStates = () => {
    ...
    const getOneData = async () => {
        const { data } = await axiosInstance.get(`masterstates/view/${dataId}`)
        console.log(data[0]);
        console.log(data);
    ...
    const submit = async (e) => {
        ...
        try {
            console.log(data);
            if (!err) {
            const { result } = await axiosInstance.put(`masterstates/update/${dataId}`, ddata
            )
            swal("Yeah", "State Updated", "success");
            ...
            <div className="row container ">
                <div className="row align-items-center mb-3">
                    <div className="col-md-6">
                        <h3 className="my-2">Update State</h3>
                    </div>
                    <div className="col-md-6 text-end">
                        <Link to="/master/states" title='Edit' className="btn btn-warning" >View All States</Link>
                    </div>
                </div>
                    ...
                    <form acceptCharset="utf-8" className="mainForm" onSubmit={(e) => submit(e)}>
                        ...
                        <div className="mb-3">
                            ...
                            <div className="mb-3">
                                ...
                                <select className="form-select" id='country' name="country" value={ddata.country} onChange={(e) => handle(e)}>
                                <option value="" selected>select</option>
