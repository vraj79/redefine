...
const getAllNotifications = async () => {
    const { data } = await axiosInstance.get(`notifications/view`)
  ...
  const deleteNotification=async(id)=>{
    const res = await axiosInstance.delete(`notifications/delete/${id}`)
    getAllNotifications();
  }
                ...
                >
                  <Card sx={{ mx: 2, mb: 3 }} elevation={3}>
                    ...
                    <Box sx={{ px: 2, pt: 1, pb: 2 }}>
                      ...
                      <Small sx={{ color: secondary }}>{notification.subtitle}</Small><br/>
                      <Link to={notification.path}><small>Check Here</small></Link>
                      {/* <Small className="messageTime">
                        {getTimeDifference(new Date(Number(notification.timestamp)))}
                          &nbsp;ago
                      </Small> */}
                    </Box>
                  </Card>
